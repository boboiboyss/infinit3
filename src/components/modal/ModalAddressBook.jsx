...
const ModalAddressBook = ({ isOpen, onClose }) => {
      ...
      {transactionStep === 1 && (
        <>
          ...
          {isOpened ? (
            <>
              ...
              <div className="space-y-2 mt-12">
                <button
                  ...
                  className="bg-black text-white p-4 text-center rounded-lg w-full text-sm"
                >
                  Next: Deposit USDT
                </button>
              </div>
            ...
            <>
              <p className="text-xl font-bold">Approve USDT allowance</p>
              <p className="text-sm text-center">
                Please confirm the transaction in your wallet to approve an allowance
                of 500 USDT towards the Infinit3 smart contract.
              </p>
