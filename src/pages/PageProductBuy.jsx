 ...
 useEffect(() => {
    ...
    const connectWallet = async () => {
        if (!isMetaMaskInstalled()) {
             alert('MetaMask is not installed or enabled in your browser. Please install and enable MetaMask to proceed.');
            return;
        }
        ...
        try {
            ...
            console.error('Gagal menghubungkan MetaMask:', error.message);
        }
    };
          ...
          <div className="right w-full md:w-1/2 h-auto md:h-screen bg-[#C5D2F7] px-6 py-8 md:px-12 md:py-20">
            {isDone ? (
              ...
              <div>
                ...
                {walletAddress && (
                  <div className=" bg-white p-3 rounded-lg my-6">
                    <div className="flex items-center space-x-4">
                      <img src={metamask} alt="coin" className="w-8 h-8 md:w-10 md:h-10 rounded-full object-cover" />
                      <div className="flex flex-col gap-y-1">
